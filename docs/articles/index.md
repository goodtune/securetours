...
Real-world insights into secure travel, event management and VIP logistics — drawn from over three decades of operational experience with AFS Group.
...
One of Australia's largest public events, attracting over 3 million visitors across 23 nights. AFS Group provided crowd management, access control and VIP guest services across multiple Sydney precincts.

[Read case study](vivid-sydney.md){ .st-btn .st-btn-navy }
</div>

<div class="st-card" markdown>
### [Carriageworks — Multi-Event Venue Security](carriageworks.md)
*Case Study · Venue Security Program*
...
## Matt Harrison — Interviews & Features

Audio interviews with Secure Tours & Travel founder Matthew Harrison discussing the vision behind the business, the Australian secure travel market, and what makes the AFS Group approach different.

Audio files to be uploaded — [contact us](../contact.md) to request early access.
